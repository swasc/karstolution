...
def cmodel_frac(TC):
    ...
    e18_c4 = np.exp((- 2590000./(TK**2) - 1.89)/1000.)-1              #Beck 2005 %HCO3 -> H2O                 (1000ln alpha)
    e18_b5 = np.exp((2520000./(TK**2) + 12.12)/1000.)-1               #Beck 2005 %H2O -> CO_2**{aq}            (1000ln alpha)
    e18_a1 = (-160515./(TK**2)+1441.76/TK - 1.9585)/1000.             #Thorstenson 2004 %CO_2**{g} -> CO_2**{aq}

    e18_s1 = ((e18_c4+1)*(e18_b5+1)/(e18_a1+1))-1                      #HCO3 -> CO_2{g}

    e18_d1 = np.exp((18030./TK - 32.42)/1000.)-1                           #Kim and O'Neil 1997 %H2O -> CaCO3      (1000ln alpha)
